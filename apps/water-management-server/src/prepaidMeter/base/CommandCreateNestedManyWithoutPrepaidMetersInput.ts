...
@InputType()
class CommandCreateNestedManyWithoutPrepaidMetersInput {
...
export { CommandCreateNestedManyWithoutPrepaidMetersInput as CommandCreateNestedManyWithoutPrepaidMetersInput };
